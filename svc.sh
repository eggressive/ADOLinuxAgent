...
SVC_NAME=`systemd-escape --path "vsts.agent.likeabossmitko.RHELpool.rhelpool01.service"`
SVC_DESCRIPTION="Azure Pipelines Agent (likeabossmitko.RHELpool.rhelpool01)"
